  ...
  <section class="section section-shaped section-lg">
   <!-- <div class="shape shape-style-1 shape-primary">
	...
	<head>
		<style>
			 body {
      background: url('../assets/img/farm-bg11.jpg');
...
<div class="container ">
    	 ...
    	 <div class="row">
          <div class="col-md-8 mx-auto text-center">
            <span class="badge badge-pill mb-3" style="background-color:#00BFFF;color:white;">Crops</span>
          </div>
        </div>
          ...
          <div class="row row-content">
            <div class="col-md-12 mb-3">
				...
				<div class="card text-white bg-gradient-white mb-3 login-container">
				  ...
				  <span class="display-4" style="color:#00BFFF;font-family:'Times New Roman', Times, serif;font-weight:bold;text-decoration:underline;""> Crop Availability </span>
